    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pilote', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='copro.coproprietaireprofile', verbose_name='Pilote')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coproprietaire', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='copro.coproprietaireprofile', verbose_name='Réservé par')),
            ],
            options={
